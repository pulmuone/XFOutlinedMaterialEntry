    ...
    public partial class OutlinedMaterialEntry : Grid
    {
        ...
        public OutlinedMaterialEntry()
        {
            ...
            if (string.IsNullOrEmpty(this.customEntry.Text) || this.customEntry.Text.Length > 0)
            {
                ...
                this.placeholderContainer.TranslateTo(0, y, 100, Easing.Linear);
            ...
            else
            {
                ...
                {
                    this.placeholderContainer.TranslateTo(0, 0, 100, Easing.Linear);
        ...
        //gwise 추가
        public ICommand ReturnCommandParameter
        {
            get => (ICommand)GetValue(ReturnCommandParameterProperty);
